...
![Version: 2.0.0](https://img.shields.io/badge/Version-2.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.6.0-1-ce](https://img.shields.io/badge/AppVersion-5.6.0--1--ce-informational?style=flat-square)
...
| app.image.tag | string | `"5.6.0-1-ce"` | Overrides the image tag whose default is the chart appVersion. |
